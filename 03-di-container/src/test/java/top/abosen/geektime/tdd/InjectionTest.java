...
public class InjectionTest {
    ...
    public void setup() throws NoSuchFieldException {
        ...
        when(context.get(eq(Context.Ref.of(Dependency.class)))).thenReturn(dependency);
        Mockito.<Provider<Dependency>>when(context.get(eq(Context.Ref.of(dependencyProviderType)))).thenReturn(dependencyProvider);
    }
